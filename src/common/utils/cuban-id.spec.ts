...
describe('isCubanIdCard', () => {
  ...
  it.each([
    ['9005151234', 'diez dígitos'],
    ['900515123456', 'doce dígitos'],
    ['90051512345 6', 'con un espacio dentro'],
    ['9005151234a', 'con una letra'],
    ['', 'vacío'],
  ...
  it('rechaza lo que no es una cadena', () => {
    expect(isCubanIdCard(90051512345)).toBe(false);
  ...
  it('tolera espacios alrededor, que es lo que llega de un formulario', () => {
    expect(isCubanIdCard('  90051512345  ')).toBe(true);
  });
});
